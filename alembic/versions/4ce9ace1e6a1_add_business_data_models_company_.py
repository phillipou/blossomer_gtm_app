...
Revision ID: 4ce9ace1e6a1
Revises: b1234567890a
Create Date: 2025-07-09 07:18:27.309448
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(length=255), nullable=False),
        sa.Column(
            "account_data", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(length=255), nullable=False),
        sa.Column(
            "persona_data", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.Column(
            "campaign_data", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
...
def downgrade() -> None:
    ...
    op.add_column(
        "users",
        sa.Column(
            "rate_limit_exempt", sa.BOOLEAN(), autoincrement=False, nullable=False
        ),
    )
    op.alter_column(
        "users", "role", existing_type=sa.VARCHAR(length=20), nullable=False
    )
    op.alter_column(
    ...
    op.create_table(
        ...
        sa.Column(
            "key_hash", sa.VARCHAR(length=64), autoincrement=False, nullable=False
        ),
        sa.Column(
            "key_prefix", sa.VARCHAR(length=32), autoincrement=False, nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name="api_keys_user_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "endpoint", sa.VARCHAR(length=100), autoincrement=False, nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["api_key_id"], ["api_keys.id"], name=op.f("api_usage_api_key_id_fkey")
        ),
