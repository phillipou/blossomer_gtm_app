...
export default function Dashboard() {
  ...
  const [overview, setOverview] = useState<any>(location.state?.overview || null);
  ...
  // If url/icp are passed, fetch the data
  useEffect(() => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 grid grid-cols-[260px_1fr]">
        <div className="bg-white border-r border-gray-200 flex flex-col h-full min-h-screen">
          {/* Sidebar is loaded but not clickable */}
          <div className="pointer-events-none opacity-60">
            <SidebarNav activeTab={"company"} setActiveTab={() => {}} companyName={"Blossomer"} />
          </div>
        </div>
