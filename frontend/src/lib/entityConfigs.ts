...
export const companyConfig: EntityPageConfig<CompanyOverviewResponse> = {
  ...
  emptyStateConfig: {
    title: 'Generate Your First Company',
    subtitle: 'Create your first company profile with our AI-powered wizard. Enter your website URL and let us help you generate detailed business insights.',
...
export const accountConfig: EntityPageConfig<TargetAccountResponse> = {
  ...
  cardConfigs: [
    {
      key: 'accountProfileInsights',
      label: 'Account Profile',
      bulleted: true,
      getItems: (account) => account.accountProfileInsights || [],
      subtitle: 'Core account characteristics and fit analysis.',
    },
    {
      key: 'accountStrengths',
      label: 'Account Strengths',
      bulleted: true,
      getItems: (account) => account.accountStrengths || [],
      subtitle: 'Key strengths and capabilities of this account type.',
    },
    {
      key: 'accountChallenges',
      label: 'Account Challenges',
      bulleted: true,
      getItems: (account) => account.accountChallenges || [],
      subtitle: 'Common challenges and pain points for this account type.',
    },
    {
      key: 'accountOpportunities',
      label: 'Opportunities',
      bulleted: true,
      getItems: (account) => account.accountOpportunities || [],
      subtitle: 'Key opportunities and value drivers for this account.',
    },
    {
      key: 'accountApproach',
      label: 'Approach Strategy',
      bulleted: true,
      getItems: (account) => account.accountApproach || [],
      subtitle: 'Recommended approach and engagement strategy.',
    },
  ],
  ...
  routePrefix: {
    authenticated: '/app/target-accounts',
    unauthenticated: '/playground/target-accounts',
  },
  emptyStateConfig: {
    title: 'Generate Your First Target Account',
    subtitle: 'Create your first target account profile with detailed analysis of your ideal customer segments.',
...
export const personaConfig: EntityPageConfig<TargetPersonaResponse> = {
  ...
  cardConfigs: [
    {
      ...
      bulleted: true,
      getItems: (persona) => persona.personaInsights || [],
    ...
    },
    {
      ...
      label: 'Pain Points',
      bulleted: true,
      getItems: (persona) => persona.painPoints || [],
    ...
    },
    {
      ...
      label: 'Motivations',
      bulleted: true,
      getItems: (persona) => persona.motivations || [],
    ...
    },
    {
      ...
      bulleted: true,
      getItems: (persona) => persona.communicationStyle || [],
    ...
    },
    {
      ...
      bulleted: true,
      getItems: (persona) => persona.decisionFactors || [],
  ...
  emptyStateConfig: {
    title: 'Generate Your First Persona',
    subtitle: 'Create detailed buyer personas to understand your target audience better.',
...
export const campaignConfig: EntityPageConfig<EmailGenerationResponse> = {
  ...
  emptyStateConfig: {
    ...
    subtitle: 'Create targeted campaigns with personalized messaging for your prospects.',
