...
class TestGenerateTargetAccountProfile:
    ...
    async def test_generate_target_account_profile_success(self):
        ...
        with patch("backend.app.services.target_account_service.ContextOrchestratorService") as mock_service_class:
            ...
            assert result.target_account_description == "Mid-market SaaS companies with growth potential"
    ...
    async def test_generate_target_account_profile_with_all_fields(self):
        ...
        expected_response = TargetAccountResponse(
            ...
            key_characteristics={
                ...
                "business_priorities": ["Digital transformation", "Operational efficiency", "Compliance"],
            ...
            buying_signals=[
                {
                    ...
                    "indicators": ["CTO/CDO appointments", "Technology budget increases"],
            ...
            engagement_strategy={
                "primary_channels": ["Executive events", "Partner referrals", "Account-based marketing"],
                "messaging_themes": ["Digital transformation", "Compliance", "Risk mitigation", "ROI"],
                "content_types": ["Executive briefings", "Compliance guides", "ROI studies"],
            ...
            metadata={
                ...
                "assumptions_made": ["Enterprise buying patterns", "Compliance requirements"],
                "primary_context_source": "user_input"
            }
        )
