...
class TestGenerateTargetPersonaProfile:
    ...
    async def test_generate_target_persona_profile_success(self):
        ...
        expected_response = TargetPersonaResponse(
            ...
            psychographics={
                ...
                "goals": ["Modernize technology stack", "Improve system reliability", "Build scalable solutions"],
                "challenges": ["Technical debt", "Talent acquisition", "Budget constraints"],
                "values": ["Innovation", "Quality", "Collaboration"],
                "preferred_communication": "Technical depth with business context"
            },
            day_in_life={
                "primary_responsibilities": ["Technical strategy", "Team leadership", "Architecture decisions"],
                ...
                "information_sources": ["Technical blogs", "Industry conferences", "Peer networks"]
            },
            pain_points=[
            ...
            buying_behavior={
                ...
                "evaluation_criteria": ["Technical fit", "Scalability", "Security", "ROI"],
            ...
            messaging_preferences={
                "communication_channels": ["Email", "LinkedIn", "Technical conferences"],
                "content_types": ["Technical whitepapers", "Case studies", "Architecture guides"],
                "messaging_tone": "Technical but accessible",
                "key_value_propositions": ["Technical excellence", "Scalability", "Innovation"],
            ...
            metadata={
                "sources_used": ["company_context", "target_account_context", "user_input"],
                "context_quality": "sufficient",
                "assessment_summary": "Good persona definition with technical focus",
                "assumptions_made": ["Standard CTO responsibilities", "Mid-market company structure"],
                "primary_context_source": "user_input"
            }
        )
        
        with patch("backend.app.services.target_persona_service.ContextOrchestratorService") as mock_service_class:
            ...
            assert result.persona_description == "Senior technology leader responsible for technical strategy"
    ...
    async def test_generate_target_persona_profile_with_all_fields(self):
        ...
        comprehensive_response = TargetPersonaResponse(
            ...
            psychographics={
                "motivations": ["Product success", "User satisfaction", "Market growth"],
                "goals": ["Launch successful products", "Increase user adoption", "Drive revenue growth"],
                "challenges": ["Competing priorities", "Resource constraints", "Technical complexity"],
                "values": ["Customer-centricity", "Data-driven decisions", "Innovation"],
                "preferred_communication": "Strategic with tactical details"
            },
            day_in_life={
                "primary_responsibilities": ["Product strategy", "Roadmap planning", "Stakeholder management"],
                "tools_used": ["Jira", "Slack", "Figma", "Analytics tools", "Roadmap tools"],
                "meeting_schedule": "60% meetings, 40% strategic work",
                "decision_making_process": "Data-driven with user feedback",
                "information_sources": ["User research", "Market analysis", "Competitive intelligence"]
            },
            pain_points=[
            ...
            buying_behavior={
                ...
                "evaluation_criteria": ["User impact", "Technical feasibility", "Business value", "Integration ease"],
                "decision_timeline": "2-4 months",
            ...
            messaging_preferences={
                ...
                "content_types": ["Product comparisons", "ROI calculators", "User success stories"],
                "messaging_tone": "Strategic and outcome-focused",
                "key_value_propositions": ["User experience", "Business impact", "Implementation ease"],
            ...
            metadata={
                "sources_used": ["company_context", "target_account_context", "user_input", "website_content"],
                "context_quality": "rich",
                "assessment_summary": "Comprehensive persona analysis with rich context",
                "assumptions_made": ["Standard PM responsibilities", "B2B product focus", "Enterprise context"],
                "primary_context_source": "user_input"
            }
        )
